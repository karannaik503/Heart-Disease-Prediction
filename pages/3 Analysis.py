...
def show_dashboard():
    ...
    with col1:
        ...
        st.write('Age vs. Target Variable')
        fig, ax = plt.subplots(figsize=(8, 6))
        sns.boxplot(x='age', y='target', showmeans=True,
                    data=df, ax=ax)  # Use boxplot here
        st.pyplot(fig)
    ...
    with col2:
        ...
        fig, ax = plt.subplots(figsize=(8, 6))
        sns.barplot(x='sex', y='target', data=df, ax=ax)
        st.pyplot(fig)
    ...
    with col3:
        ...
        fig, ax = plt.subplots(figsize=(8, 6))
        sns.barplot(x='fasting_blood_sugar', y='target', data=df, ax=ax)
        st.pyplot(fig)
    ...
    with col1:
        ...
        fig, ax = plt.subplots(figsize=(8, 6))
        sns.barplot(x='resting_ecg', y='target', data=df,
    ...
    with col2:
        ...
        fig, ax = plt.subplots(figsize=(8, 6))
        sns.barplot(x='exercise_angina', y='target', data=df, ax=ax)
        st.pyplot(fig)
    ...
    with col3:
        ...
        fig, ax = plt.subplots(figsize=(8, 6))
        sns.barplot(x='ST_slope', y='target', data=df, ax=ax)
        st.pyplot(fig)
